<template>
  <div
    class="signup-page d-flex justify-content-center align-items-center vh-100"
    style="
  ...
  >
    <div
      class="signup-container p-4 rounded"
      ...
      <form @submit.prevent="handleSignup">
        ...
        <div class="mb-3 d-flex align-items-center">
          <Checkbox
            ...
            inputId="agree-to-terms"
            name="agree-to-terms"
            value="agree-to-terms"
          />
          <label for="agree-to-terms" class="ms-2 text-white"
            >약관에 동의합니다</label
          >
        </div>
